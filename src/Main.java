...
public class Main {
    public static void main(String[] args) {
        ...
        // Tạo đối tượng Model.Model để quản lý dữ liệu trò chơi
        Model model = new Model();

        // Tạo đối tượng View.View để hiển thị trò chơi
        View view = new View(model);

        // Tạo đối tượng Control.Control để điều khiển trò chơi
        Control control = new Control(model, view);

        // Thêm đối tượng View.View vào JFrame
        f.add(view);
